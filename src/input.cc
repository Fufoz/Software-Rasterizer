...
/*There is a strange bug in sdl resulting in large
* mouse movements at the program startup
* when we lock mouse to the creen center.
*/
bool ignoreFirstMouseMove = true;
